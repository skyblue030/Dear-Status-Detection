"""
LEGACY — capture_process.py as submitted in the group graduation project (Spring 2024).

NOTE: The original LINE Notify access token was hardcoded as a string literal in
this file at submission time. It has been replaced with a placeholder here for
security. The token itself was invalidated automatically when LINE Notify was
discontinued by LINE on 2025-03-31. See `solo_v2/live_program/capture_process.py`
for the dotenv-based replacement that was introduced post-submission.

Authorship: this entire file was written by [project owner] during the group
project; see PROVENANCE.md at the repo root for the full attribution.
"""
...
# token: <REDACTED — was a hardcoded LINE Notify access token>
...
# 替換為你自己的 Access Token
token = "REDACTED_LINE_NOTIFY_TOKEN"  # original was a hardcoded literal here
